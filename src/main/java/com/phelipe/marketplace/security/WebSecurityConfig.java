...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private UsuarioDetailsConfig usuaruioDetailsConfig;
    ...
    public void configureUserDetails(AuthenticationManagerBuilder builder)
            throws Exception {
        builder.userDetailsService(usuaruioDetailsConfig).passwordEncoder(new BCryptPasswordEncoder());
         
        //$2a$10$qrtoVQyVmvjDmHHq7/VezO6Nej0X38hS.x9hpMw30PRsPrRPGKLJi
    }
